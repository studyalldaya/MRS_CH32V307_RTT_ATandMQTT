...
C_SRCS += \
../packages/at_device-latest/class/ec200x/at_device_ec200x.c \
../packages/at_device-latest/class/ec200x/at_socket_ec200x.c 

OBJS += \
./packages/at_device-latest/class/ec200x/at_device_ec200x.o \
./packages/at_device-latest/class/ec200x/at_socket_ec200x.o 

C_DEPS += \
./packages/at_device-latest/class/ec200x/at_device_ec200x.d \
./packages/at_device-latest/class/ec200x/at_socket_ec200x.d 


# Each subdirectory must supply rules for building sources it contributes
packages/at_device-latest/class/ec200x/%.o: ../packages/at_device-latest/class/ec200x/%.c
