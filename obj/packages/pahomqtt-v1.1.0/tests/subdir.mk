...
C_SRCS += \
../packages/pahomqtt-v1.1.0/tests/mqtt_test.c 

OBJS += \
./packages/pahomqtt-v1.1.0/tests/mqtt_test.o 

C_DEPS += \
./packages/pahomqtt-v1.1.0/tests/mqtt_test.d 


# Each subdirectory must supply rules for building sources it contributes
packages/pahomqtt-v1.1.0/tests/%.o: ../packages/pahomqtt-v1.1.0/tests/%.c
