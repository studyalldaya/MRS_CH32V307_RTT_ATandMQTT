...
C_SRCS += \
../rt-thread/components/net/lwip-2.0.3/src/apps/httpd/fs.c \
../rt-thread/components/net/lwip-2.0.3/src/apps/httpd/fsdata.c \
../rt-thread/components/net/lwip-2.0.3/src/apps/httpd/httpd.c 

OBJS += \
./rt-thread/components/net/lwip-2.0.3/src/apps/httpd/fs.o \
./rt-thread/components/net/lwip-2.0.3/src/apps/httpd/fsdata.o \
./rt-thread/components/net/lwip-2.0.3/src/apps/httpd/httpd.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.0.3/src/apps/httpd/fs.d \
./rt-thread/components/net/lwip-2.0.3/src/apps/httpd/fsdata.d \
./rt-thread/components/net/lwip-2.0.3/src/apps/httpd/httpd.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.0.3/src/apps/httpd/%.o: ../rt-thread/components/net/lwip-2.0.3/src/apps/httpd/%.c
